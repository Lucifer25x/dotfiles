/* TODO:
 * 	- Add commands for keyboard backlight
 *	- Change colors
...
static const char *incbright[] = {"brightnessctl", "-q", "s", "+5%", NULL };
static const char *decbright[] = {"brightnessctl", "--min-val=5", "-q", "s", "5%-", NULL };
static const char *kbdauran[] = {"asusctl", "aura", "-n", NULL};
static const char *kbdaurap[] = {"asusctl", "aura", "-p", NULL};
